...
var _productslist = require("./store/reducers/productslist");
var _productsReducer = require("./store/reducers/productsReducer");
...
var _whishlistReducer = require("./store/reducers/whishlistReducer");
var _whishlistReducerDefault = parcelHelpers.interopDefault(_whishlistReducer);
...
const reducer = (0, _redux.combineReducers)({
    ...
    whisList: (0, _whishlistReducerDefault.default)
});
...
console.log((0, _productslist.productlist));
store.dispatch((0, _cartReducer.cartAddItem)({
    id: 3,
    quantity: 4
}));
store.dispatch((0, _cartReducer.cartAddItem)({
...
store.dispatch((0, _cartReducer.cartRemoveItem)(1));
store.dispatch((0, _cartReducer.increaseItem)({
    id: 1
}));
store.dispatch((0, _cartReducer.decreaseItem)({
    id: 12
}));
store.dispatch({
...
},{"redux":"anWnS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./store/reducers/productsReducer":"8xiUi","./store/reducers/cartReducer":"5zqqP","./store/reducers/whishlistReducer":"gNKnC","./store/reducers/productslist":"16gia"}],"anWnS":[function(require,module,exports) {
...
},{}],"8xiUi":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>productReducer);
var _productslist = require("./productslist");
function productReducer(state = (0, _productslist.productlist), action) {
    return state;
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./productslist":"16gia"}],"16gia":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5zqqP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "CART_ADD_ITEM", ()=>CART_ADD_ITEM);
parcelHelpers.export(exports, "CART_REMOVE_ITEM", ()=>CART_REMOVE_ITEM);
parcelHelpers.export(exports, "INCREASE_PRODUCT_QUANTITY", ()=>INCREASE_PRODUCT_QUANTITY);
parcelHelpers.export(exports, "DECREASE_PRODUCT_QUANTITY", ()=>DECREASE_PRODUCT_QUANTITY);
parcelHelpers.export(exports, "cartAddItem", ()=>cartAddItem);
parcelHelpers.export(exports, "cartRemoveItem", ()=>cartRemoveItem);
parcelHelpers.export(exports, "increaseItem", ()=>increaseItem);
parcelHelpers.export(exports, "decreaseItem", ()=>decreaseItem);
parcelHelpers.export(exports, "default", ()=>cartReducer);
const CART_ADD_ITEM = "cart/additem";
const CART_REMOVE_ITEM = "cart/removeitem";
const INCREASE_PRODUCT_QUANTITY = "product/increaseItem";
const DECREASE_PRODUCT_QUANTITY = "product/decreaseItem";
function cartAddItem(payload) {
    return {
        type: CART_ADD_ITEM,
        payload: payload
    };
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gNKnC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["80FRq","f47v6"], "f47v6", "parcelRequire2d1f")
